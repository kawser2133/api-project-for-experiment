...
namespace B_Service
{
    public static class MorphoDevice
    {
        [DllImport("morpho_core.dll", CallingConvention = CallingConvention.Cdecl, SetLastError = true)]
        public static extern bool InitSdk(string A_0);

        [DllImport("morpho_core.dll", CallingConvention = CallingConvention.Cdecl, SetLastError = true)]
        public static extern bool InitDevice(string A_0);

        [DllImport("morpho_core.dll", CallingConvention = CallingConvention.Cdecl, SetLastError = true)]
        public static extern bool GetImage(string key, MorphoDevice.eval_a A_1, byte[] imageBytes, ref int width, ref int height, int A_5);

        [DllImport("morpho_core.dll", CallingConvention = CallingConvention.Cdecl, SetLastError = true)]
        public static extern bool CancelCapture(string A_0);

        [DllImport("morpho_core.dll", CallingConvention = CallingConvention.Cdecl, SetLastError = true)]
        public static extern int GetPreviewImageSize(string A_0);

        [DllImport("morpho_core.dll", CallingConvention = CallingConvention.Cdecl, SetLastError = true)]
        public static extern void GetPreviewImageDimension(string A_0, ref int A_1, ref int A_2);

        [DllImport("morpho_core.dll", CallingConvention = CallingConvention.Cdecl, SetLastError = true)]
        public static extern int GetMorphoImageHeaderSize(string A_0);

        [DllImport("morpho_core.dll", CallingConvention = CallingConvention.Cdecl, SetLastError = true)]
        public static extern int GetCaptureImageSize(string A_0);

        [DllImport("morpho_core.dll", CallingConvention = CallingConvention.Cdecl, SetLastError = true)]
        public static extern bool ReleaseResource(string A_0);

        public delegate int eval_a(IntPtr A_0, MorphoDevice.DataBit A_1, IntPtr A_2);
